    ...
    def post(self, request):
        ...
        for item in creates:
            ...
            try:
                ...
                print(f"Error creating {entity_type}: {str(e)}")
        ...
        for item in updates:
            ...
            try:
                if entity_type == 'product':
                    ...
                    if obj:
                        client_updated = datetime.fromisoformat(data['updated_at'].replace('Z', '+00:00'))
                        if client_updated > obj.updated_at:
                ...
                print(f"Error updating {entity_type}: {str(e)}")
        ...
        for item in deletes:
            ...
            try:
                ...
                print(f"Error deleting {entity_type}: {str(e)}")
    ...
    def get(self, request):
        ...
        if since:
            try:
                ...
                inventory_qs = inventory_qs.filter(updated_at__gte=since_dt)
